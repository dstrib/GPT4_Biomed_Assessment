...
#   Version 0.1.2 - Add paragraph with instructions regarding sources
...
PROMPT_TEMPLATE_EXPERT = textwrap.dedent("""\
    ...
    If a question refers to materials, sources, or references used in the course,
    do your best to guess what materials were used in the course to answer the question.
    Provide citations for sources if the question asks for sources or references.
